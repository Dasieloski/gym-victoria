            ...
            <div className="mb-8 w-full">
                ...
                <div className="flex space-x-4 overflow-x-auto pb-4">
                    {clientesProximosPagos.map((client) => (
                        <div key={client.id} className="flex-shrink-0 w-64">
                ...
                {/* Opcional: Botones de navegación */}
                <div className="flex justify-end space-x-2 mt-2">
                    <button onClick={() => {/* Lógica para deslizar hacia la izquierda */}} className="px-4 py-2 bg-gray-300 text-gray-800 rounded hover:bg-gray-400">
                        <ChevronLeft size={20} />
                    </button>
                    <button onClick={() => {/* Lógica para deslizar hacia la derecha */}} className="px-4 py-2 bg-gray-300 text-gray-800 rounded hover:bg-gray-400">
